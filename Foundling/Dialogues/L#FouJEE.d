...
END
IF~ClassLevelLT(Myself,WIZARD,4)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW1",Myself,1,0,0)~ EXIT
IF~ClassLevelGT(Myself,WIZARD,3)
ClassLevelLT(Myself,WIZARD,8)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW2",Myself,1,0,0)~ EXIT
IF~ClassLevelGT(Myself,WIZARD,7)
ClassLevelLT(Myself,WIZARD,13)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW3",Myself,1,0,0)~ EXIT
IF~ClassLevelGT(Myself,WIZARD,12)
ClassLevelLT(Myself,WIZARD,17)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW4",Myself,1,0,0)~ EXIT
IF~ClassLevelGT(Myself,WIZARD,16)
ClassLevelLT(Myself,WIZARD,23)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW5",Myself,1,0,0)~ EXIT
IF~ClassLevelGT(Myself,WIZARD,22)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW6",Myself,1,0,0)~ EXIT
