...
END
IF~LevelLT(Myself,4)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW1",Myself,1,0,0)~ EXIT
IF~LevelGT(Myself,3)
LevelLT(Myself,8)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW2",Myself,1,0,0)~ EXIT
IF~LevelGT(Myself,7)
LevelLT(Myself,13)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW3",Myself,1,0,0)~ EXIT
IF~LevelGT(Myself,12)
LevelLT(Myself,17)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW4",Myself,1,0,0)~ EXIT
IF~LevelGT(Myself,16)
LevelLT(Myself,23)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW5",Myself,1,0,0)~ EXIT
IF~LevelGT(Myself,22)~THEN REPLY @1 /* Yes. */ DO ~SetGlobal("L#SMITH","LOCALS",2) ApplySpellRES("L#DE",Myself) GiveItemCreate("L#SBSW6",Myself,1,0,0)~ EXIT
